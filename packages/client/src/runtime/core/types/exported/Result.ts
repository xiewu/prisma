...
// prettier-ignore
export type GetFindResult<P extends OperationPayload, A, ClientOptions> = Equals<A, any> extends 1
...
// prettier-ignore
export type SelectField<P extends SelectablePayloadFields<any, any>, K extends PropertyKey> = P extends {
...
// prettier-ignore
export type DefaultSelection<Payload extends OperationPayload, Args = {}, ClientOptions = {}> = Args extends {
  omit: infer LocalOmit
}
  ? // Both local and global omit, local settings override globals
    ApplyOmit<
      UnwrapPayload<{ default: Payload }>['default'],
...
// prettier-ignore
export type UnwrapPayload<P> = {} extends P
  ? unknown
  : {
      [K in keyof P]: P[K] extends { scalars: infer S; composites: infer C }[]
...
// prettier-ignore
export type GetGroupByResult<P extends OperationPayload, A> = A extends { by: string[] }
...
// prettier-ignore
export type ExtractGlobalOmit<Options, ModelName extends string> = Options extends {
